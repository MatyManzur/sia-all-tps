...
def run_test(test_config: dict, test_eval: dict):
    ...
    def runnable(i):
        ...
        autoencoder = VariationalAutoencoder(
            ...
            optimizer_encoder=get_optimizer(test_config['architecture']['optimizer'], amount_of_layers),
            optimizer_decoder=get_optimizer(test_config['architecture']['optimizer'], amount_of_layers)
        )
...
if __name__ == '__main__':
    config = json.load(open("./vaetests_config.json", "r"))
    output = {'tests': []}
